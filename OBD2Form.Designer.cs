namespace OBD_II_WiFi
{
    partial class OBD2Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            display.Location = new Point(7, 300);
            display.Margin = new Padding(3, 3, 10, 3);
            display.Name = "display";
            display.Size = new Size(281, 255);
            display.TabIndex = 5;
            display.Text = "";
            // 
            // askPIDButton
            ...
            // button1
            // 
            button1.Location = new Point(898, 532);
            button1.Name = "button1";
            button1.Size = new Size(166, 23);
            button1.TabIndex = 8;
            button1.Text = "chart test add data";
            ...
            evalDriveButton.Click += evalDriveButton_Click_1;
            // 
            // chart_speed
            // 
